...
# filtering site 0 for CBU and selecting only the subj_id and
# transforming df to a list
subjects = df.query("site == 0")["sub_id"].tolist()
...
mf_cal_fname = deriv_root / 'sss_cal_CBU.dat'
mf_ctc_fname = deriv_root / 'ct_sparse_CBU.fif'
